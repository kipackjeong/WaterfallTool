...
const ServerItem = ({ sqlServerInfo, toggleDatabase, expandedDatabases, setInstanceViewState }) => {
...
const DatabaseItem = ({ databaseInfo, sqlServerInfo, toggleDatabase, expandedDatabases, setInstanceViewState }) => {
    return (
        <>
            <Flex
                sx={{
